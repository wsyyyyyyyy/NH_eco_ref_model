...
======================================================================
포털 `apply_macro_shock` 은 구 모델(230피처) 기준이고 D8(164피처)과 피처 교집합이
...
def main() -> None:
    ...
    md(f"모델 `eda_pipeline/output/lgbm_v2_full.txt` (D8, 164피처) · "
    ...
    md("- **S2 KORIBOR 스프레드**: `ix_KORIBOR_spread_d12__liq` 한 항이 반응한다. "
       "이 항은 D8 거시 gain 0.98% 중 약 0.6%p 를 담당하는 **유일하게 유효한 거시 채널**이다. "
